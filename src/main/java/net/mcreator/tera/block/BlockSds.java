...
package net.mcreator.tera.block;
...
public class BlockSds extends ElementsTeraMod.ModElement {
	@GameRegistry.ObjectHolder("tera:sds")
	public static final Block block = null;
	public BlockSds(ElementsTeraMod instance) {
		super(instance, 1);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("tera:sds", "inventory"));
	}
